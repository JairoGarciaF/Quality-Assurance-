  ...
  test("Update one field on an issue: PUT", function(done) {
        chai
          ...
          .end(function(err, res) {
            ...
            assert.strictEqual(res.body.result, undefined, "result property must be equal to successfully updated");
            done();
          });
  ...
  test("Delete an issue: DELETE", function(done) {
        chai
          ...
          .end(function(err, res) {
            ...
            assert.strictEqual(res.body.result, undefined, "result property must be equal to successfully deleted");
            done();
          })
